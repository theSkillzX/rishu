...
const Contact = () => {
  ...
  return (
    <>
    <Navbar/>
    <div className="relative mx-auto w-full max-w-7xl bg-white text-gray-700 pt-8">
      <div className="grid grid-cols-2">
        
        {/* :MAP CONTAINER */}
        <div className="order-1 col-span-full">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3603.286821929324!2d81.93321019999999!3d25.4286727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39854b47dd9fbc71%3A0x68afd80dd92476f0!2sNishtha%20Hospital!5e0!3m2!1sen!2sin!4v1688449103094!5m2!1sen!2sin"  title="map" scrolling="no" frameborder="0"
        ...
        <div className="order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <form action="" className="mx-auto max-w-xl space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              {/* :::label */}
              <label htmlFor="name" className="sr-only border-black bo">Name</label>
              {/* :::input */}
              <input ref={nameRef} type="text" id="name" name="name"
                placeholder="Name"
                className="form-input w-full block shadow-sm rounded  border-mauve bg-gray-100 placeholder-mauve focus:border-berry focus:ring-berry p-1"
              />
            </div>
            {/* ::Email Input */}
            <div>
              ...
              <input ref={emailRef} type="email" id="email" name="email"
                ...
                className="form-input w-full block shadow-sm rounded border-gray-300  border-mauve bg-gray-100 placeholder-mauve focus:border-berry focus:ring-berry p-1"
              />
            </div>
            {/* ::Message Input */}
            <div className="col-span-full">
              ...
              <textarea ref={messageRef} name="message" id="message" cols="30" rows="4"
                ...
                className="form-textarea resize-none w-full shadow-sm rounded border-mauve bg-gray-100 placeholder-mauve focus:border-berry focus:ring-berry p-1"
              ></textarea>
            </div>
            {/* ::Submit Button */}
            <div>
              <button type="submit" className="py-2 px-6 rounded bg-mauve hover:bg-berry text-base text-white font-semibold uppercase hover:bg-green-500">Send Message</button>
            </div>
          </form>
        </div>
